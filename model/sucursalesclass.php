...
class Sucursales extends Database
{
	...
	public function listarSucursales($idorganizacion = 0){
		...
		$query = $this->consulta("SELECT `idsucursal`, `nombre`, `sucursales`.`direccion`, `sucursales`.`telefono`, `email`, `organizaciones_idorganizacion`, `sucursales`.`ciudades_idciudad`, `organizaciones`.`razon_social`, `ciudades`.`ciudad`
									FROM `sucursales` 
	...
	public function detalleSucursal($idsucursal){
		...
		$query = $this->consulta("
									SELECT `idsucursal`, `nombre`, `direccion`, `telefono`, `email`, `organizaciones_idorganizacion`, `ciudades_idciudad` 
									FROM `sucursales` 
									INNER JOIN `ciudades` ON (`ciudades`.`idciudad` = `sucursales`.`ciudades_idciudad`)
	...
	public function crearSucursal($nombre = '', $direccion = '', $telefono = '', $email = '', $idorganizacion = 0 ,$idciudad = 0){
	...
	public function actualizarSucursal($idsucursal = 0, $nombre = '', $direccion = '', $telefono = '', $email = '', $idorganizacion = 0 ,$idciudad = 0){
