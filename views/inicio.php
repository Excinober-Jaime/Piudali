...
<div class="container">
	...
	<div class="col-xs-12" style="background-color:#FFF8EB;padding:20px;">
		...
		<br>
		<p class="text-center">PIUDALÍ® es una marca de Waliwa Natural Products Ltda.
una empresa Colombiana que cree en la riqueza biológica existente en nuestro País y por esto decide investigar y combinar tecnología, sabiduría ancestral,  naturaleza,  ciencia  y  conciencia.</p>
		<p class="text-center">Esta iniciativa nace de dos mujeres empresarias, químicas farmacéuticas, amantes de la Naturaleza, quienes a través de una alianza entre los Laboratorios de especialidades cosméticas ESKO y laboratorios MYN de Bogotá, dan vida en el año 2009 a la empresa Waliwa Natural Products Ltda.</p>
	</div>
