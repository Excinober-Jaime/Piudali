	...
	<div class="col-xs-12 col-md-9">
		...
		<div class="row">
			...
			foreach ($productos_relacionados as $producto_relacionado) {
				...
				producto_bloque($producto_relacionado["img_principal"],$producto_relacionado["nombre"],$producto_relacionado["codigo"],$producto_relacionado["precio"],$producto_relacionado["precio_oferta"],$producto_relacionado["url"],"col-sm-4");
			}
			?>
		</div>
	</div>
